...
return (
 <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} ${props.mcolor}`}>
    <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button type="button" class="btn btn-warning" onClick={props.togglecolor1}>Mode</button>
...
// Navbar.PropTypes = {navName: PropTypes.string}
Navbar.propTypes ={navName: PropTypes.string}
